package com.jhd.hops.minimw.security.jwt.util;
...
public class JwtTokenizer {
	...
	public final static Long REFRESH_TOKEN_EXPIRE_COUNT = 7 * 24 * 60 * 1000L; // 7 days
	...
	public String createToken(Long id, String meail, List<String> roles,
								Long expire, byte[] secretKey) {
		Claims claims = Jwts.claims().setSubject(meail);
